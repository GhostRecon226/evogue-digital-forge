...
const Privacy = () => (
  <div className="min-h-screen bg-brand-bg text-brand-primary">
    <Helmet>
      ...
      />
      <link rel="canonical" href="https://evogueconsulting.com/privacy" />
      {/* Open Graph */}
      ...
      <meta
        ...
        content="How Evogue Consulting collects, uses, and protects your personal information when you interact with our website and services."
      />
      <meta property="og:url" content="https://evogueconsulting.com/privacy" />
      <meta property="og:image" content="https://evogueconsulting.com/og-image.jpg" />
      ...
      <meta
        ...
        content="How Evogue Consulting collects, uses, and protects your personal information when you interact with our website and services."
      />
      <meta name="twitter:image" content="https://evogueconsulting.com/og-image.jpg" />
    </Helmet>
    <Nav />
