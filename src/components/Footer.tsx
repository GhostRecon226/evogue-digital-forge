            ...
            <ul className="space-y-3">
              {quickLinks.map((l) => (
                <li key={l.label}>
                  <Link
                    to={l.to}
                    className="text-sm font-medium text-brand-primary/70 hover:text-brand-primary transition-colors duration-200"
                  >
                    {l.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-sm font-medium text-brand-primary/70 hover:text-brand-primary transition-colors duration-200"
                >
